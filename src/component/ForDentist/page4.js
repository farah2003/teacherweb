...
class FPage extends Component{
  ...
  getData = ()=>{
    ...
    let newList =[]
    db.collection("patients").where('classD','==',true).get().then((userSnapshot) => {
     ...
     list.map((item,index)=>{
      ...
      >
                <Button type="primary" style={{width:200,marginRight:60}}> select this  </Button>
                  ...
                  <h3 style={{fontSize:18}}> <label style={{fontSize:18,marginRight:7}}> treatment: </label>Molar filling</h3>
